...
require (
	...
	lab.nexedi.com/kirr/go123 v0.0.0-20230205112549-0399d7ad8db9
...
replace github.com/hanwen/go-fuse/v2 v2.3.0 => lab.nexedi.com/kirr/go-fuse/v2 v2.3.1-0.20230614151023-eb4d413d568b
